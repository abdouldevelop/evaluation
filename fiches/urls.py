...
from .views import tableau_de_bord, dashboard_directeur, ajouter_evaluation, fiche_evaluation, generate_pdf, \
    ...
    donner_decision_finale, dashboard_dg, voir_mes_notes_evaluation, telecharger_template_csv, exporter_agents_csv
from django.urls import path
from django.contrib.auth.views import LogoutView
...
urlpatterns = [
    ...
    path('gestionrh/exporter-agents-csv/', exporter_agents_csv, name='exporter_agents_csv'),
